...
<div className='join'>
<div className='stj12'>
    <img src={substj} className='stj1'></img>
    <br></br>
    <img src={substj1} className='stj2'></img>
</div>
<div>
<img src={substj4} className='swami'></img>
</div>
<div>
    <img src={substj2} className='stj3'></img>
    <br></br>
    <img src={substj3} className='stj4'></img>
    <br></br>
</div>
</div>
);
